...
execute if entity @s[tag=forgotten_echoes.waiting_for_input] on target unless items entity @s weapon.mainhand *[minecraft:custom_data~{id:"key"}] run return fail 
