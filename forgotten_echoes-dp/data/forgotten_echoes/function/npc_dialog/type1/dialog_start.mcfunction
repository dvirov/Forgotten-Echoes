...
execute if score @s forgotten_echoes.dialog_line matches 6 run tellraw @a[distance=..10] [{color:white,text:""},"<",{"selector":"@s"},"> ",{text:"Well it was nice to me you but now you must release me back to my slumber. just use the "},"ITEM HERE"]
