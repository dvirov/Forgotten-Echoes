...
execute if score @s forgotten_echoes.dialog_line matches 2 run tellraw @a[distance=..10] [{color:white,text:""},"<",{"selector":"@s"},"> ",{text:"Before the "},{color:"#2a4073",text:"nameremoved",obfuscated:true},{text:"\ntook this place, we tried to forge Special bell —an anchor to keep our memories safe from the darkness. When the "},{color:"#2a4073",text:"nameremoved",obfuscated:true},{text:"\n rose, I panicked and hide it"}]
