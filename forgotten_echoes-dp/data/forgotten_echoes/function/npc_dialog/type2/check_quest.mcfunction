...
execute if entity @s[tag=forgotten_echoes.waiting_for_input] on target if items entity @s weapon.mainhand *[minecraft:custom_data~{id:"calibrated_echo_bell"}] run function forgotten_echoes:npc_dialog/quest_success
