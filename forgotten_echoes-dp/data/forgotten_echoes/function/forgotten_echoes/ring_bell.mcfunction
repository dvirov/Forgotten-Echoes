...
execute as @e[tag=forgotten_echoes.summoning_spot_trader,distance=..300,type=item_frame] at @s run function forgotten_echoes:forgotten_echoes/ghosts/trader
