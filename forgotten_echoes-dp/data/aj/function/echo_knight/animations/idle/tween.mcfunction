...
tag @s add aj.echo_knight.animation.idle.playing
...
execute at @s run function aj:echo_knight/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:echo_knight/animations/idle/zzz/apply_frame {frame: $(to_frame)}
