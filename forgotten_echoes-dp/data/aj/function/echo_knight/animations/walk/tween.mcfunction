...
tag @s add aj.echo_knight.animation.walk.playing
...
execute at @s run function aj:echo_knight/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function aj:echo_knight/animations/walk/zzz/apply_frame {frame: $(to_frame)}
