...
tag @s add aj.ghost_villager_a.animation.idle.playing
...
execute at @s run function aj:ghost_villager_a/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:ghost_villager_a/animations/idle/zzz/apply_frame {frame: $(to_frame)}
