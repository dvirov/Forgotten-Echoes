...
execute unless score @s gu.uuid.0 matches -2147483648.. run function ceapi:tools/uuid/zzz/store_uuid
...
function ceapi:tools/uuid/zzz/get_hexes with storage gu:temp
function ceapi:tools/uuid/zzz/concat_uuid with storage gu:temp
