...
data modify storage ceapi:summondata args.type set value "boss_minion"
#datapack path (MODIFY)
data modify storage ceapi:summondata args.path set value "boss_minion/ceapi_template"
