...
data modify storage ceapi:phasedata args.basic.core set value "ceapi_template_core"
...
#datapack path
data modify storage ceapi:phasedata args.basic.path set value "boss/ceapi_template"

#id of the bossbar to modify
data modify storage ceapi:phasedata args.bossbar.id set value "ceapi_template"
#name of the bossbar
