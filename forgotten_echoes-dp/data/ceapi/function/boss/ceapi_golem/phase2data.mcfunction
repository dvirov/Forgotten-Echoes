...
data modify storage ceapi:phasedata args.basic.model set value "ceapi_golem"
#tag that the core AI entity has
data modify storage ceapi:phasedata args.basic.core set value "ceapi_golem_core"
...
#datapack path
data modify storage ceapi:phasedata args.basic.path set value "boss/ceapi_golem"

#id of the bossbar to modify
data modify storage ceapi:phasedata args.bossbar.id set value "ceapi_golem"
#name of the bossbar
data modify storage ceapi:phasedata args.bossbar.name set value [{"text":"\uE001","font":"ceapi:bossbars"},{"text":"    ","font":"default"}]
#bossbar color
...
attribute @s movement_speed base set 0.275

#length of music in ticks
data modify storage ceapi:phasedata args.music.max set value 550
#name of the music for /playsound
data modify storage ceapi:phasedata args.music.sound set value "ceapi:sfx.golem.bossmusic.phase2"
...
#data modify storage ceapi:phasedata args.idle_sound set value "sfx.boss.ceapi_golem.idle"
...
data modify storage ceapi:phasedata args.phase.current set value 2
...
data modify storage ceapi:phasedata args.phase.max set value 2
...
data modify storage ceapi:phasedata args.attacks.close set value [1,1,2,4,4,4,6,5,5,7,7,7]
#which attacks can be used at range mid
data modify storage ceapi:phasedata args.attacks.mid set value [2,3,5,6,4,4,7,7]
#which attacks can be used at range far
data modify storage ceapi:phasedata args.attacks.far set value [3,5,6,7,7,7]
...
#update bossbar
function ceapi:global/bossbar/edit with storage ceapi:temp args