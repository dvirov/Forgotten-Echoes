...
#bossbar color
data modify storage ceapi:phasedata args.bossbar.color set value "red"
#bossbar max
...
title @a[tag=ceapi.inbossfight] subtitle {"text":"Redstone Exacavator","color":"red","bold":true}

#length of music in ticks
data modify storage ceapi:phasedata args.music.max set value 586
#name of the music for /playsound
data modify storage ceapi:phasedata args.music.sound set value "ceapi:sfx.golem.bossmusic.phase1"
...
data modify storage ceapi:phasedata args.phase.transition_type set value "3of6"
