...
data modify storage ceapi:phasedata args.basic.type set value "custom"
#datapack path
data modify storage ceapi:phasedata args.basic.path set value "custom/ceapi_template"
